...
import com.shiol.crud.repository.UsuarioRepository;
...
/**
 * REST controller for managing {@link com.shiol.crud.domain.Usuario}.
 */
@RestController
        ...
        Optional<Usuario> result = usuarioRepository
            ...
            .map(existingUsuario -> {
                ...
                if (usuario.getBirthday() != null) {
                    existingUsuario.setBirthday(usuario.getBirthday());
                }
